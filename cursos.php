...
if ($pdo) {
    try {
        $stmt = $pdo->query("SELECT c.id, c.titulo, c.descripcion, c.nivel, c.duracion, c.fecha_creacion,
...
// 1. Lógica para generar los botones de filtro (niveles)
$niveles = [];
...
$initialFilter = 'Todas'; // Valor inicial para Alpine
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        /* Variables de Diseño (Iguales a recetas.php) */
        :root {
            --primary: #ffffff;         /* Blanco */
            --secondary: #4ecdc4;       /* Teal/Turquesa (Acento) */
            --dark: #2c3e50;            /* Azul Oscuro (Texto y Fondo Footer) */
            --light: #ecf0f1;           /* Fondo del Cuerpo (Gris muy claro) */
            --theme-green: #69A64A;     /* Verde Plano */
            --shadow-clean: rgba(44, 62, 80, 0.1); /* Sombra limpia */
        }
        ...
        /* ESTILOS APLICADOS PARA EL MENÚ DESPLEGABLE (Fix de recetas.php) */
        .dropdown-menu {
        ...
        .dropdown-menu a:hover {
            background-color: #588e43 !important; /* Verde ligeramente más oscuro que --theme-green */
        }
        /* ------------------------------------------- */
        ...
        /* GRID: siempre 3 columnas en desktop (Iguales a recetas.php) */
        .grid { 
            display: grid;
        ...
        /* Tarjetas (Iguales a recetas.php) */
        .card { 
            background-color: var(--primary);
            border-radius: 12px; 
            overflow: hidden; 
        ...
        .card-category { /* Usado para Nivel */
        ...
        .card-text { 
            ...
            line-height: 1.5; 
            flex-grow: 1;
            /* Usamos line-clamp para limitar la descripción */
            display: -webkit-box;
            -webkit-line-clamp: 3;
        ...
        @media (max-width: 768px) {
            ...
            .app-nav { margin-top: 1rem; justify-content: center; }
        ...
        <nav class="app-nav flex items-center">
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                <div class="relative ml-4" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <!-- Uso de la clase dropdown-menu para el CSS fix -->
                    <div x-show="open" x-transition class="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 dropdown-menu">
                        <a href="<?= htmlspecialchars($dashboard_url) ?>" class="block px-4 py-2 text-sm">
                            <i class="fas fa-gauge-high mr-2"></i> Mi perfil
                        </a>
                        <a href="logout.php" class="block px-4 py-2 text-sm border-t border-white/25">
            ...
            <?php else: ?>
                <div class="relative ml-4" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <!-- Uso de la clase dropdown-menu para el CSS fix -->
                    <div x-show="open" x-transition class="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 dropdown-menu">
                        <a href="login.php" class="block px-4 py-2 text-sm">
                            <i class="fas fa-sign-in-alt mr-2"></i> Entrar
                        </a>
                        <a href="registro.php" class="block px-4 py-2 text-sm border-t border-white/25">
...
<main class="container" style="min-height: 50vh;">
    ...
    <!-- Botones de Filtro por Nivel (Usando Alpine.js) -->
    ...
    <?php else: ?>
        ...
        <!-- GRID DE CURSOS (Mismo diseño y clases que las recetas) -->
        <div class="grid" aria-live="polite">
            <?php foreach($cursos as $curso): 
                ...
                $imagePath = 'img/cursos/' . $safe_id . '.jpg';
            ?>
                <div class="card"
                    ...
                    <img src="<?= $imagePath ?>"
                         onerror="this.onerror=null;this.src='https://via.placeholder.com/400x220/4ecdc4/ffffff?text=Nivel+<?= rawurlencode($nivelReceta) ?>';"
                         class="card-img" 
                         alt="Curso de <?= $safe_titulo ?>">

                    <div class="card-body">
                        <!-- Usamos card-category para el Nivel -->
