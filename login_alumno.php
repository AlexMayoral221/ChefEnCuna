...
<body>
    <header>
        ...
        <nav>
            ...
            <?php else: ?>
                <a href="login_alumno.php" class="btn-login" style="border-color:var(--primary); color:var(--primary);">Alumno</a>
    ...
    <div class="content-wrapper">
        <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-custom border border-gray-100">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-extrabold text-gray-800">Acceso de Alumnos</h1>
                <p class="text-gray-500">Inicia sesión para acceder a las recetas y cursos.</p>
            </div>
            ...
            <form method="POST" action="login_alumno.php" class="space-y-6">
                <div>
                ...
                <button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-primary hover-bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition duration-150 ease-in-out">
                    Entrar como Alumno
                </button>
            </form>
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                ¿No tienes cuenta?
                <a href="registro.php" class="font-medium text-primary hover:text-red-700">
                    Regístrate aquí
                </a>
            </p>
            <p class="mt-2 text-center text-sm text-gray-600">
                ...
                <a href="login_maestro.php" class="font-medium text-gray-400 hover:text-gray-600">
                    Ir a Login de Maestros
                </a>
            </p>
        </div>
    </div>
