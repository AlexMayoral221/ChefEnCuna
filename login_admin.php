...
<body>
    <header>
        ...
        <nav>
            ...
            <?php else: ?>
                <a href="login_admin.php" class="btn-login" style="border-color:#3498db; color:#3498db;">Admin</a>
    ...
    <div class="content-wrapper">
        <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-custom border border-gray-100">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-extrabold text-gray-800">Acceso de Administradores</h1>
